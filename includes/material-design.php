...
function mentor_material_design( $material_design_included ) {
	...
	$material_design = array(
        ...
        'mdi mdi-water-polo',
        'mdi mdi-ab-testingaccess-point',
	...
	$material_design_included[ 'material_design' ] = array(
		'name' 	     => 'Material Design',
		'prefix'     => '',
		'type'       => '',
		'icons'		   => $material_design,
	);
	
	return $material_design_included;

    
}

add_filter( 'fl_builder_icon_sets', 'mentor_material_design' );